...
class CivicapiGraphql
{
    ...
    // equivalent.
    public static function body(CivicapiContext $ctx): mixed
    {
    ...
    public static function errors(CivicapiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
