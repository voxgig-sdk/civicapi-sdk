...
// Civicapi SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CivicapiOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CivicapiOmni::structfix($now, Struct::undef()))
                        !== json_encode(CivicapiOmni::structfix($val, Struct::undef()))) {
