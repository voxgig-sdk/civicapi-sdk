...
// Civicapi SDK ratelimit feature
...
class CivicapiRatelimitFeature extends CivicapiBaseFeature
{
    ...
    private function _acquire(CivicapiContext $ctx): void
    {
    ...
    private function _track(CivicapiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
