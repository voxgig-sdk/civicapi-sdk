...
class CivicapiRbacFeature extends CivicapiBaseFeature
{
    ...
    private function _required(CivicapiContext $ctx): ?string
    {
    ...
    private function _reject(CivicapiContext $ctx, string $required): void
    {
    ...
    private function _track(CivicapiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
