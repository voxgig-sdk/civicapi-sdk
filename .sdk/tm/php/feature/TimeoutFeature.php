...
class CivicapiTimeoutFeature extends CivicapiBaseFeature
{
    ...
    private function _with_timeout(CivicapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CivicapiContext $_ctx, float $ms): void
    {
        $client = $this->client;
