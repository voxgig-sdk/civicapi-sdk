...
// Civicapi SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CivicapiTestFeature extends CivicapiBaseFeature
{
    ...
    public function init(CivicapiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CivicapiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CivicapiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CivicapiContext $ctx, $op, $args): array
    {
