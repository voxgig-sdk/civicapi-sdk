...
|---|---|---|
| `ts/` | @voxgig-sdk/civicapi-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/civicapi-sdk \
      --repository voxgig-sdk/civicapi-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/civicapi-sdk` shows it, and
`npm trust revoke @voxgig-sdk/civicapi-sdk --id=<id>` removes it.
