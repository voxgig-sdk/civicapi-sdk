...
from civicapi_sdk.core.helpers import get_ctx_prop, to_map
...
class CivicapiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, CivicapiResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CivicapiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CivicapiError(code, msg, self)
