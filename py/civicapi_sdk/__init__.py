...
from civicapi_sdk.utility import register

# Load features
from civicapi_sdk.feature.base_feature import CivicapiBaseFeature
from civicapi_sdk.features import _has_feature, _make_feature
...
class CivicapiSDK:
    ...
    def get_utility(self):
        return CivicapiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CivicapiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Election(self, data=None) -> "ElectionEntity":
        ...
        from civicapi_sdk.entity.election_entity import ElectionEntity
    ...
    def Polling(self, data=None) -> "PollingEntity":
        ...
        from civicapi_sdk.entity.polling_entity import PollingEntity
    ...
    def Result(self, data=None) -> "ResultEntity":
        ...
        from civicapi_sdk.entity.result_entity import ResultEntity
