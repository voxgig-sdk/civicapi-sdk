# Civicapi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CivicapiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CivicapiSDK(...) and CivicapiSDK.test(...) become
#      CivicapiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "civicapi_sdk"
_SDK_CLASS = "CivicapiSDK"
