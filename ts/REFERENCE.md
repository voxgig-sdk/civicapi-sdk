# Civicapi TypeScript SDK Reference

Complete API reference for the Civicapi TypeScript SDK.
...
```ts
new CivicapiSDK(options?: object)
```
...
#### `CivicapiSDK.test(testopts?, sdkopts?)`
...
**Returns:** `CivicapiSDK` instance in test mode.
...
Create a new `Polling` entity instance.
...
**Returns:** `PollingEntity` instance.
...
Return the parent `CivicapiSDK` instance.
