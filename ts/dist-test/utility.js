...
function envOverride(m) {
    if ('TRUE' === process.env.CIVICAPI_TEST_LIVE ||
        'TRUE' === process.env.CIVICAPI_TEST_OVERRIDE) {
    ...
    m.CIVICAPI_TEST_EXPLAIN = process.env.CIVICAPI_TEST_EXPLAIN || m.CIVICAPI_TEST_EXPLAIN;
    return m;
}
