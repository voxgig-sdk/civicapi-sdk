...
function basicSetup(extra) {
    ...
    let idmap = transform(['result01', 'result02', 'result03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
