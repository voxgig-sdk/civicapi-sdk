...
(0, node_test_1.describe)('ElectionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-election', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-election', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CIVICAPI_TEST_ELECTION_ENTID'];
...
//# sourceMappingURL=ElectionDirect.test.js.map