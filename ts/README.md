...
The TypeScript SDK for the Civicapi API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new CivicapiSDK({ apikey: '...' })
