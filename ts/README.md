# Civicapi TypeScript SDK



The TypeScript SDK for the Civicapi API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Election()` — each with a small set of operations (`list`)
...
- Releases: [https://github.com/voxgig-sdk/civicapi-sdk/releases](https://github.com/voxgig-sdk/civicapi-sdk/releases)
...
| `tester(testopts?, sdkopts?)` | `CivicapiSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `CivicapiSDK.test(testopts?, sdkopts?)` | `CivicapiSDK` | Create a test-mode client. |
...
| `client` | `client(): CivicapiSDK` | Return the parent SDK client. |
...
```ts
const results = await client.Result().list({ election_id: "example" })
```
