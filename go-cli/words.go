...
func registerSDKWords(r *eng.Registry, client *sdk.CivicapiSDK) {
...
func runOp(client *sdk.CivicapiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
