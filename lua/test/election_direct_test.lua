...
describe("ElectionDirect", function()
  it("should direct-list-election", function()
    local setup = election_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-election", setup.live and "live" or "unit")
...
function election_direct_setup(mockres)
