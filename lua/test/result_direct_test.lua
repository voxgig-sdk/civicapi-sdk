...
describe("ResultDirect", function()
  it("should direct-list-result", function()
    local setup = result_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-result", setup.live and "live" or "unit")
...
function result_direct_setup(mockres)
