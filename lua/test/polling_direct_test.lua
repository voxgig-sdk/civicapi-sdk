...
describe("PollingDirect", function()
  it("should direct-list-polling", function()
    local setup = polling_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-polling", setup.live and "live" or "unit")
...
function polling_direct_setup(mockres)
