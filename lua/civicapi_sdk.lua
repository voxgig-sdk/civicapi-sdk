...
local CivicapiSDK = {}
CivicapiSDK.__index = CivicapiSDK
...
CivicapiSDK._make_feature = _make_feature


function CivicapiSDK.new(options)
  local self = setmetatable({}, CivicapiSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function CivicapiSDK:options_map()
...
function CivicapiSDK:get_utility()
  return Utility.copy(self._utility)
end


function CivicapiSDK:get_root_ctx()
  return self._rootctx
end


function CivicapiSDK:prepare(fetchargs)
...
function CivicapiSDK:direct(fetchargs)
...
-- by passing it.
function CivicapiSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function CivicapiSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "CivicapiSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function CivicapiSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = CivicapiSDK.new(sdkopts)
  sdk.mode = "test"
