...
import (
	...
	vs "github.com/voxgig-sdk/civicapi-sdk/go/utility/struct"
)

type ElectionEntity struct {
	name    string
	client  *core.CivicapiSDK
...
func NewElectionEntity(client *core.CivicapiSDK, entopts map[string]any) *ElectionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ElectionEntity) GetName() string { return e.name }
...
func (e *ElectionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ElectionEntity) Deleted() bool {
	return e.deleted
}


func (e *ElectionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewElectionEntity(e.client, opts)
}

func (e *ElectionEntity) Data(args ...any) any {
...
func (e *ElectionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Election; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ElectionEntity) DataTyped(data ...Election) Election {
	if len(data) > 0 {
		return typedFrom[Election](e.Data(asMap(data[0])))
	}
	return typedFrom[Election](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Election (all fields
// optional at the wire level).
func (e *ElectionEntity) MatchTyped(match ...Election) Election {
	if len(match) > 0 {
		return typedFrom[Election](e.Match(asMap(match[0])))
	}
	return typedFrom[Election](e.Match())
}
...
func (e *ElectionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ElectionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ElectionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ElectionListMatch and returns []Election. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ElectionEntity) ListTyped(reqmatch ElectionListMatch, ctrl map[string]any) ([]Election, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Election](res), nil
}



func (e *ElectionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ElectionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ElectionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ElectionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
