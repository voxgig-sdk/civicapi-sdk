...
func NewResultEntity(client *core.CivicapiSDK, entopts map[string]any) *ResultEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ResultEntity) Deleted() bool {
	return e.deleted
}


func (e *ResultEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewResultEntity(e.client, opts)
}

func (e *ResultEntity) Data(args ...any) any {
...
func (e *ResultEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Result; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ResultEntity) DataTyped(data ...Result) Result {
	if len(data) > 0 {
		return typedFrom[Result](e.Data(asMap(data[0])))
	}
	return typedFrom[Result](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Result (all fields
// optional at the wire level).
func (e *ResultEntity) MatchTyped(match ...Result) Result {
	if len(match) > 0 {
		return typedFrom[Result](e.Match(asMap(match[0])))
	}
...
func (e *ResultEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ResultEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ResultListMatch and returns []Result. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ResultEntity) ListTyped(reqmatch ResultListMatch, ctrl map[string]any) ([]Result, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Result](res), nil
}



func (e *ResultEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ResultEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ResultEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
