...
const testSeed = `map[string]any{"entity": map[string]any{"election": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "polling": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "result": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
