...
class PollingDirectTest extends TestCase
{
    public function test_direct_list_polling(): void
    {
        $setup = polling_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-polling", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
