...
class ResultDirectTest extends TestCase
{
    public function test_direct_list_result(): void
    {
        $setup = result_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-result", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
