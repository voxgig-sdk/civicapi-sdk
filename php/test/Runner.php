...
class CivicapiTestRunner
{
    ...
    {
        $live = self::getenv('CIVICAPI_TEST_LIVE');
        $override = self::getenv('CIVICAPI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CIVICAPI_TEST_EXPLAIN');
...
class_alias('CivicapiTestRunner', 'Runner');
class_alias('CivicapiHelpers', 'Helpers');
