...
{
    private static function utility(): CivicapiUtility
    {
        return new CivicapiUtility();
    }
    ...
    private static function ctx(array $over = []): CivicapiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CivicapiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CivicapiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CivicapiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CivicapiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CivicapiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CivicapiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CivicapiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CivicapiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CivicapiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CivicapiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CivicapiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CivicapiResponse([]),
            'result' => new CivicapiResult([]),
        ]);
        [, $err] = CivicapiMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CivicapiSpec([]),
            'response' => null,
            'result' => new CivicapiResult([]),
        ]);
        [, $err] = CivicapiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CivicapiSpec(['step' => 's']),
            'response' => new CivicapiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CivicapiResult([]),
        ]);
        [, $err] = CivicapiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CivicapiSpec(['step' => 's']),
            'response' => new CivicapiResponse(self::resp(200, ['v' => 1])),
            'result' => new CivicapiResult([]),
        ]);
        [, $err] = CivicapiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CivicapiSpec(['step' => 's']),
            'response' => new CivicapiResponse(self::resp(200, ['v' => 2])),
            'result' => new CivicapiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CivicapiMakeResponse::call($ctx);
    ...
    {
        $preset = new CivicapiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CivicapiSpec([]),
            'response' => new CivicapiResponse([]),
            'result' => new CivicapiResult([]),
        ...
        [$got, $err] = CivicapiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CivicapiResult([])]);
        [, $err] = CivicapiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CivicapiSpec([]), 'result' => null]);
        [, $err] = CivicapiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CivicapiSpec(['step' => 's']),
            'result' => new CivicapiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CivicapiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CivicapiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CivicapiSpec(['step' => 's']),
            'result' => new CivicapiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CivicapiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CivicapiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CivicapiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CivicapiSpec([]),
            'result' => new CivicapiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CivicapiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CivicapiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CivicapiError('boom', 'boom');
        $utility->fetcher = function (CivicapiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CivicapiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CivicapiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CivicapiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CivicapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CivicapiResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CivicapiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CivicapiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CivicapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CivicapiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CivicapiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CivicapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CivicapiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CivicapiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CivicapiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CivicapiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CivicapiResult(['ok' => false])]);
        $this->expectException(CivicapiError::class);
        CivicapiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CivicapiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CivicapiMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CivicapiMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CivicapiBaseFeature();
        $b = new CivicapiBaseFeature();
        CivicapiFeatureAdd::call($ctx, $a);
        CivicapiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CivicapiBaseFeature
    {
        $f = new CivicapiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CivicapiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CivicapiContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CivicapiSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CivicapiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CivicapiResponse(['headers' => null]),
            'result' => new CivicapiResult([]),
        ]);
        CivicapiResultHeaders::call($ctx);
