...
// Civicapi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CivicapiSDK::test)
...
{
    private const SDK_CLASS = 'CivicapiSDK';
    ...
    private const SDK_BASE = 'civicapi_sdk';
