...
class ResultEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ResultEntity($this->_client, $opts);
    }

    /**
     * @param Result|array $args Result data (assoc-array) to store.
     */
    ...
    /**
     * @return Result|array The current Result data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Result fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Result fields).
     */
