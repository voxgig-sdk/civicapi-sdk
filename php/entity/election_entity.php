...
class ElectionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ElectionEntity($this->_client, $opts);
    }

    /**
     * @param Election|array $args Election data (assoc-array) to store.
     */
    ...
    /**
     * @return Election|array The current Election data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Election fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Election fields).
     */
     ...
     *
     * @param ElectionListMatch|array|null $reqmatch Match filter (any subset
     *   of Election fields) as an assoc-array; ElectionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Election[]|array A list of Election items as assoc-arrays at
