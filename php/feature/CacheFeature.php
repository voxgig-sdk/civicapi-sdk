...
class CivicapiCacheFeature extends CivicapiBaseFeature
{
    ...
    private function _through(CivicapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
