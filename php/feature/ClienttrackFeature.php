...
// Civicapi SDK clienttrack feature
...
class CivicapiClienttrackFeature extends CivicapiBaseFeature
{
    ...
    public function PostConstruct(CivicapiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Civicapi-SDK';
