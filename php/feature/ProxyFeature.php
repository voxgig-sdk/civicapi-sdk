...
class CivicapiProxyFeature extends CivicapiBaseFeature
{
    ...
    public function init(CivicapiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CivicapiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
