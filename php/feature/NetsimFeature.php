...
class CivicapiNetsimFeature extends CivicapiBaseFeature
{
    ...
    private function _simulate(CivicapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CivicapiContext $ctx, array $applied): void
    {
        $client = $this->client;
