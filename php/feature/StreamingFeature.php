...
// Civicapi SDK streaming feature
...
class CivicapiStreamingFeature extends CivicapiBaseFeature
{
    ...
    private function _iterate(CivicapiResult $result): \Generator
    {
    ...
    private function _streamable(CivicapiContext $ctx): bool
    {
