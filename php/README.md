...
The PHP SDK for the Civicapi API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Election(null)->list(null, null);
...
[$result, $err] = $client->Civicapi(null)->load(
    ["id" => "test01"], null
);
