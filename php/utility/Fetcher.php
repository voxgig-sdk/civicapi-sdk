...
// Civicapi SDK utility: fetcher

class CivicapiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CivicapiSDK/1.0)';
    ...
    public static function call(CivicapiContext $ctx, string $fullurl, array $fetchdef): array
    {
