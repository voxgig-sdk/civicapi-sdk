...
// Civicapi SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CivicapiMakeRequest
{
    public static function call(CivicapiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CivicapiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CivicapiResponse($fetched);
        } else {
