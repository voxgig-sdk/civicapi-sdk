...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/civicapi` | `npm install @voxgig-sdk/civicapi` |
| Python | `voxgig-sdk-civicapi` | `pip install voxgig-sdk-civicapi` |
| PHP | `voxgig-sdk/civicapi` | `composer require voxgig-sdk/civicapi` |
| Golang | `github.com/voxgig-sdk/civicapi-sdk/go` | `go get github.com/voxgig-sdk/civicapi-sdk/go` |
| Ruby | `voxgig-sdk-civicapi` | `gem install voxgig-sdk-civicapi` |
| Lua | `voxgig-sdk-civicapi` | `luarocks install voxgig-sdk-civicapi` |
