...
The Ruby SDK for the Civicapi API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `CivicapiError` (a `StandardError` subclass), so wrap
...
```
rb/
├── Civicapi_sdk.rb       -- Main SDK module
...
The main module (`Civicapi_sdk`) exports the SDK class
