...
class ElectionEntity
  ...
  def make
    opts = @_entopts.dup
    ElectionEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [ElectionListMatch, Hash, nil] match filter (any subset of
  #   Election fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Election>, Array] the matching Election items; raises CivicapiError on failure
