...
class ResultEntity
  ...
  #
  # @param reqmatch [ResultListMatch, Hash, nil] match filter (any subset of
  #   Result fields); defaults to nil, treated as an empty match that lists all.
