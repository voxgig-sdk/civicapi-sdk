...
module CivicapiTestRunner
  ...
  def self.env_override(m)
    live = getenv("CIVICAPI_TEST_LIVE")
    override = getenv("CIVICAPI_TEST_OVERRIDE")
    ...
    explain = getenv("CIVICAPI_TEST_EXPLAIN")
    m["CIVICAPI_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CivicapiTestRunner
Helpers = CivicapiHelpers
Vs = VoxgigStruct
